...
public class VideoClub {
	...
	private Cliente clientes[];// composición
	private ProductoVC productos[]; //composición
	private Alquiler alquileres[]; // composición
	...
	public void alquilar ()
	{
		...
		if (alquileres[alquileres.length - 1] == null)
		{
			...
			*/
			...
			// comprobar si el producto está alquilado
